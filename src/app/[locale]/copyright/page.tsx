...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Stream a Mukbang Wiki',
    description: 'Copyright and intellectual property information for Stream a Mukbang Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Stream a Mukbang Wiki',
      description: 'Copyright and intellectual property information for Stream a Mukbang Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Stream a Mukbang Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Stream a Mukbang Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Stream a Mukbang Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Stream a Mukbang Developers</strong> - Creators of the Stream a Mukbang game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Stream a Mukbang</strong> - Trademark of the game developers</li>
              <li><strong>Stream a Mukbang Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Stream a Mukbang Wiki.
            </p>
            ...
            <p>
              ...
              Stream a Mukbang Wiki<br />
              Email: <a href="mailto:dmca@streamamukbangwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@streamamukbangwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Stream a Mukbang Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Stream a Mukbang Wiki (streamamukbangwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@streamamukbangwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@streamamukbangwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@streamamukbangwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@streamamukbangwiki.wiki</a>
            </p>
            <p>
